...
const Register = () => {
  ...
  return (
    <div className="h-screen w-full bg-black text-white p-0 md:p-5 flex flex-col md:flex-row gap-0 md:gap-5">
      ...
      {/* left side */}
      <div className="h-full w-full md:max-w-[560px] rounded-none md:rounded-[24px] p-8 md:p-10 bg-[#0A0A0B] border-0 md:border border-white/[0.08] flex flex-col justify-center">

        <div className="flex flex-col gap-2">
          <h1 className="font-semibold text-[28px] sm:text-[30px] md:text-[32px] tracking-tight leading-[1.15]">
            Let's Get You Started
          </h1>
          <p className="font-light text-[14px] text-white/40 leading-relaxed">
            Create an account to start exploring, organizing, and finding answers faster.
          </p>
        </div>
        ...
        <form className="mt-8">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="w-full h-[46px] bg-[#141416] rounded-[10px] px-4 items-center gap-3 flex border border-white/[0.08] focus-within:border-white/25 transition-colors">
                <i className="ri-user-line text-[17px] text-white/30"></i>
                <input
                  id="name"
            ...
            <button
              type="submit"
              className="w-full h-[46px] mt-1 rounded-[10px] bg-white text-black font-medium text-[15px] hover:bg-white/90 transition-colors"
            >
              Create account
            </button>
            ...
            <button
              type="button"
              className="w-full h-[46px] rounded-[10px] border border-white/[0.08] flex items-center justify-center gap-3 font-normal text-[14px] text-white/85 hover:bg-white/[0.04] hover:border-white/15 transition-colors"
            >
      ...
      {/* right side — hidden on mobile, drop your image in here */}
      <div className="hidden md:flex flex-1 h-full items-center justify-center">
        {
          <img
            src="/register-side-image.png"
